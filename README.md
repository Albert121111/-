...
2. Откройте `Profile` → `Developers`.
3. На странице Developers нажмите кнопку **Register application** (справа сверху).
4. Заполните форму приложения и сохраните.
5. Откройте созданное приложение и скопируйте `Access Token` (строка вида `MLY|...`).
